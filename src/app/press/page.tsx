      ...
      <section className="py-12 px-4 bg-gray-50/30">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Live Statistics</h2>
            <p className="text-gray-600 mb-6">Real-time data from the Truce Compliance Index</p>
      ...
      <section className="py-12 px-4">
        <div className="max-w-4xl mx-auto">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-2">Embed Widget</h2>
            <p className="text-gray-600 mb-6">Add live Truce Index data to your website</p>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-gray-100/50 rounded-xl p-6 border border-gray-200/50">
                <h3 className="font-semibold text-gray-900 mb-2">Academic Citation</h3>
              ...
              <div className="bg-gray-100/50 rounded-xl p-6 border border-gray-200/50">
                <h3 className="font-semibold text-gray-900 mb-2">News Attribution</h3>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="font-semibold text-lg text-gray-600 mb-2">Media Officer</h3>
