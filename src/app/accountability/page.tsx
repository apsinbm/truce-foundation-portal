...
const TRUCE_PERIODS: TrucePeriod[] = [
  {
    ...
    violations: [
      ...
      },
      {
        country: 'Pakistan',
        countryIso3: 'PAK',
        description: 'Cross-border airstrikes and ground operations into Afghanistan targeting Taliban positions (February 22 and 26, 2026), breaking de facto arrangements with Taliban government and causing mass displacement',
        date: '2026-02-22',
        severity: 'major',
        sources: ['Media Reports', 'Crisis Group'],
      },
    ],
  },
  {
