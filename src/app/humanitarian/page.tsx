...
const PRIORITY_COUNTRIES = [
  ...
  },
  {
    ...
    iso3: 'SDN',
    status: 'extreme',
    description: 'Chad border closure (Feb 23) cut off refugee routes. RSF mass displacement attacks (Feb 26) intensifying humanitarian catastrophe.',
    acapsScore: 5,
    issues: ['Chad border closure', 'RSF mass displacement attacks', 'Refugee route disruption'],
  },
  {
    name: 'Iran',
    iso3: 'IRN',
  ...
  },
  {
    ...
    iso3: 'LBN',
    status: 'high',
    description: 'Israeli strikes on Beirut and Bekaa Valley continue. Hezbollah disarmament plan rejected. Humanitarian access impeded by ongoing military operations.',
    acapsScore: 4,
    issues: ['Israeli military strikes', 'Disarmament impasse', 'Humanitarian access impeded'],
  },
  {
    name: 'Afghanistan',
    iso3: 'AFG',
  ...
  },
  {
    ...
    iso3: 'PAK',
    status: 'high',
    description: 'Cross-border strikes along Afghan border (Feb 22, Feb 26) creating displacement and humanitarian access challenges.',
    acapsScore: 3,
