...
const PRIORITY_COUNTRIES = [
  ...
  },
  {
    ...
    iso3: 'IRN',
    status: 'extreme',
    description: 'Active war zone following U.S.–Israel coordinated strikes. Civilian casualties reported at school sites. Strait of Hormuz tensions threaten regional supply chains.',
    acapsScore: 5,
    issues: ['Active military strikes', 'Civilian infrastructure damage', 'Strait of Hormuz tensions'],
  },
  {
    name: 'South Sudan',
    iso3: 'SSD',
