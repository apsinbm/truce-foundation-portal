...
export const SUB_SITES: SubSite[] = [
  ...
  },
  {
    id: 'co-sponsors',
    icon: '🌍',
    title: '166 UN Member States',
    description: 'Co-sponsors of Milano-Cortina 2026 Olympic Truce resolution A/80/L.10',
    href: '/co-sponsors',
    status: 'live',
    tier: 1,
  },
  // === REMAINING ITEMS (all as boxes) ===
  {
    id: 'documents',
    icon: '📚',
