    ...
    violations: [
      {
        country: 'Iran',
        countryIso3: 'IRN',
        description: 'U.S.–Israel coordinated strikes caused civilian casualties including at school sites',
        date: '2026-03-01',
        severity: 'critical',
      ...
      },
      {
        country: 'Israel',
        countryIso3: 'ISR',
        description: 'Iranian retaliatory strikes, continued military operations in Gaza with crossings closed and MSF suspended, strikes on Beirut and Bekaa Valley',
        severity: 'critical',
