...
export const TRUCE_PERIODS: TrucePeriod[] = [
  {
    ...
    violations: [
      ...
      },
      {
        country: 'Sudan',
        countryIso3: 'SDN',
        description: 'RSF mass displacement attacks and Chad border closure cutting off refugee routes',
        date: '2026-02-26',
        severity: 'critical',
        sources: ['ACLED', 'UNHCR'],
      },
      ...
      },
      {
        country: 'Lebanon',
        countryIso3: 'LBN',
        description: 'Israeli strikes on Beirut and Bekaa Valley, Hezbollah disarmament plan rejected',
        severity: 'major',
        sources: ['UN Reports', 'UNIFIL'],
      },
      {
        country: 'Afghanistan',
        countryIso3: 'AFG',
        description: 'Pakistan cross-border strikes and aerial engagements along Afghan border',
        date: '2026-02-22',
        severity: 'major',
      ...
      },
      {
        country: 'Pakistan',
        countryIso3: 'PAK',
        description: 'Border military operations including cross-border strikes into Afghanistan',
        date: '2026-02-22',
        severity: 'significant',
        sources: ['Crisis Group', 'ACLED'],
      },
      {
        country: 'Mexico',
        countryIso3: 'MEX',
