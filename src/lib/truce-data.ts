...
export const TRUCE_PERIODS: TrucePeriod[] = [
  {
    ...
    unResolution: 'A/RES/79/10',
    status: 'violated',
    violations: [
      {
        country: 'Iran',
        countryIso3: 'IRN',
        description: 'U.S.–Israel Operation Epic Fury struck Iran (Feb 28). Iran launched massive retaliatory campaign with 170+ ballistic missiles and drones targeting Israel, all six GCC states, Iraq, Jordan, and Cyprus. Strait of Hormuz closed to commercial traffic (Mar 2). IRGC claimed complete control of the Strait (Mar 4).',
        date: '2026-03-01',
        severity: 'critical',
        casualties: 26,
        sources: ['UN Reports', 'OCHA', 'Reuters', 'IRGC Statements'],
      },
      {
        country: 'Israel',
        countryIso3: 'ISR',
        description: 'Multiple waves of 170+ Iranian ballistic missiles and drones struck Tel Aviv, West Jerusalem, Haifa, and Beersheba. Beit Shemesh synagogue bomb shelter destroyed (Mar 1, 9 killed). Continued operations in Gaza with crossings closed and MSF suspended.',
        severity: 'critical',
        casualties: 12,
        sources: ['UN Reports', 'OCHA', 'MSF'],
      },
      {
        country: 'United Arab Emirates',
        countryIso3: 'ARE',
        description: 'Iranian strikes targeted Palm Jumeirah in Dubai, Etihad Towers in Abu Dhabi, Jebel Ali port, AWS data center, and Al Dhafra Air Base (Mar 1).',
        date: '2026-03-01',
        severity: 'critical',
        casualties: 3,
        sources: ['Reuters', 'OCHA'],
      },
      {
        country: 'Bahrain',
        countryIso3: 'BHR',
        description: 'Iranian strikes targeted U.S. Navy Fifth Fleet headquarters in Manama, Mina Salman port, and Crowne Plaza Hotel (Mar 1).',
        date: '2026-03-01',
        severity: 'critical',
        casualties: 2,
        sources: ['Reuters', 'U.S. DoD'],
      },
      {
        country: 'Kuwait',
        countryIso3: 'KWT',
        description: 'Iranian missiles and drones targeted infrastructure near Kuwait International Airport and oil refinery. Security alert near U.S. embassy following nearby explosions (Mar 1).',
        date: '2026-03-01',
        severity: 'critical',
        casualties: 4,
      ...
      },
      {
        country: 'Qatar',
        countryIso3: 'QAT',
        description: 'Iranian drones struck LNG facilities at Ras Laffan, halting production. Qatar Energy declared Force Majeure. Strikes also directed at Al Udeid Air Base hosting U.S. CENTCOM (Mar 1).',
        date: '2026-03-01',
        severity: 'critical',
        sources: ['Reuters', 'Qatar Energy', 'U.S. DoD'],
      },
      {
        country: 'Saudi Arabia',
        countryIso3: 'SAU',
        description: 'Explosions reported in eastern Riyadh. Aramco Ras Tanura refining facility damaged by missile debris. Saudi Arabia attempting to reroute oil exports through Red Sea port at Yanbu (Mar 1).',
        date: '2026-03-01',
        severity: 'critical',
        sources: ['Reuters', 'Aramco Reports'],
      },
      {
        country: 'Oman',
        countryIso3: 'OMN',
        description: 'Port of Duqm struck by two Iranian drones, injuring a foreign worker. Traditional role as regional mediator complicated by direct territorial impact (Mar 1).',
        date: '2026-03-01',
        severity: 'major',
        casualties: 1,
        sources: ['Reuters', 'OCHA'],
      },
      {
        country: 'Jordan',
        countryIso3: 'JOR',
        description: 'Air defenses intercepted many projectiles, but falling debris recorded in 73 incidents nationwide. Civilian areas affected by interception fallout (Mar 1).',
        date: '2026-03-01',
        severity: 'major',
        sources: ['Reuters', 'Jordan Armed Forces'],
      },
      {
        country: 'Cyprus',
        countryIso3: 'CYP',
        description: 'RAF Akrotiri base and Paphos International Airport evacuated after drone detection (Mar 1). Iran threatened to strike if U.S. forces continue operating from the island.',
        date: '2026-03-01',
        severity: 'major',
      ...
      },
      {
        country: 'Russia',
        countryIso3: 'RUS',
        description: 'Continued military operations in Ukraine throughout the Truce period. 14-nation boycott of Paralympic Opening Ceremony over Russia participation. 650+ Ukrainian athletes killed since 2022 invasion.',
        severity: 'critical',
        sources: ['UN Reports', 'OHCHR', 'IOC'],
      },
      {
        country: 'Sudan',
        countryIso3: 'SDN',
        description: 'RSF mass displacement attacks and Chad border closure cutting off refugee routes. Kordofan offensive: drone strike on Dilling General Hospital (4 killed, Mar 4). El Obeid under 5 consecutive days of drone attacks. UN issued "domicide" warning.',
        date: '2026-03-04',
        severity: 'critical',
      ...
      },
      {
        country: 'Palestine',
        countryIso3: 'PSE',
        description: 'Gaza operations resumed, crossings closed, MSF operations suspended',
        date: '2026-03-01',
        severity: 'critical',
        sources: ['OCHA', 'MSF'],
      },
      {
        country: 'Lebanon',
        countryIso3: 'LBN',
        description: 'Hezbollah launched massive strikes on Israel from southern Lebanon. Israel struck Beirut and Dahiyeh. PM Salam banned Hezbollah military activities. Area south of Litani River declared combat zone. 80,000+ displaced. 50+ deaths in first week of March.',
        date: '2026-03-02',
        severity: 'critical',
        casualties: 50,
      ...
      },
      {
        country: 'Afghanistan',
        countryIso3: 'AFG',
        description: 'Pakistan-Afghanistan border war escalation: 56 deaths, 129 injuries, 163,000+ displaced in Nangarhar/Kunar/Khost provinces. IOM hospital facility damaged. Türkiye offered mediation with Russia/China support.',
        date: '2026-03-05',
        severity: 'critical',
        casualties: 56,
        sources: ['UN Reports', 'Crisis Group', 'IOM'],
      },
      {
        country: 'Pakistan',
        countryIso3: 'PAK',
        ...
        severity: 'major',
        casualties: 56,
        sources: ['Crisis Group', 'ACLED', 'IOM'],
      },
      {
        country: 'Ecuador',
        countryIso3: 'ECU',
      ...
      },
      {
        country: 'Mexico',
        countryIso3: 'MEX',
        description: 'Cartel violence escalation during Truce period',
        severity: 'significant',
      ...
      },
      {
        country: 'Ukraine',
        countryIso3: 'UKR',
        description: 'Ongoing military operations and violence reports during Russian invasion',
        severity: 'critical',
