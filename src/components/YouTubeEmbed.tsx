  ...
  if (!isLoaded) {
    return (
      <button
        ...
        className={`relative w-full aspect-video bg-gray-100 rounded-lg overflow-hidden group ${className}`}
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/80 to-transparent">
          <p className="text-gray-900 text-sm font-medium truncate">{title}</p>
        </div>
      </button>
    );
  }
